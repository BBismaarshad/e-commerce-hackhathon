...
// const FooterHerder = () => {
//   return (
//     <div className='bg-[#FAFAFA] mb-5 shadow-md  w-full h-36 flex justify-between  px-5 items-center'>
//       <div className=' '>
//         <ul>
...
//         <li><Link href="#"><Image src={facebook} alt=""/></Link></li>
//         <li><Link href="#"><Image src={instagram} alt=""/></Link></li>
//         <li><Link href="#"><Image src={twitter} alt=""/></Link></li>
//         </ul>
//       </div>
//     </div>
//   )
